...
object RadioStationsData {
    val sampleRadios: List<RadioStation> = listOf(
        ...
        RadioStation(
            ...
            streamUrl = "https://radios.ebc.com.br/cbn-sp",
            backupStreamUrl = "https://stream.zeno.fm/0rqvbbqmdg8uv",
            logoText = "CBN",
        ...
        RadioStation(
            ...
            backupStreamUrl = "https://stream.zeno.fm/bandnews",
            logoText = "BN",
        ...
        RadioStation(
            ...
            cityState = "São Paulo - SP",
            genre = RadioGenre.NOTICIAS,
            streamUrl = "https://stream.zeno.fm/0rqvbbqmdg8uv",
            backupStreamUrl = "https://painel.radiojovempan.com.br:8000/jpnews",
            logoText = "JP NEWS",
        ...
        RadioStation(
            ...
            backupStreamUrl = "https://stream.zeno.fm/bandeirantes",
            logoText = "RB",
        ...
        RadioStation(
            ...
            backupStreamUrl = "https://stream.ebc.com.br/nacional-am-df",
            logoText = "SENADO",
        ...
        RadioStation(
            ...
            backupStreamUrl = "https://stream.zeno.fm/antena1",
            logoText = "A1",
        ...
        RadioStation(
            ...
            backupStreamUrl = "https://stream.zeno.fm/alphafm",
            logoText = "ALPHA",
        ...
        RadioStation(
            ...
            genre = RadioGenre.FLASHBACK,
            streamUrl = "https://stream.zeno.fm/jbfm",
        ...
        RadioStation(
            ...
            backupStreamUrl = "https://stream.zeno.fm/saudadefm",
            logoText = "SAUDADE",
        ...
        RadioStation(
            ...
            cityState = "São Paulo - SP",
            genre = RadioGenre.POP,
            streamUrl = "https://stream.zeno.fm/8k5rbbqmdg8uv",
            backupStreamUrl = "https://ice.fabricahost.com.br/metropolitanafm",
            logoText = "METRO",
            accentColorHex = 0xFFD81B60,
            currentShow = "Chupim & Melhores Lançamentos",
            bitrate = "128 kbps MP3"
        ),
        RadioStation(
            id = "mix_fm",
            ...
            backupStreamUrl = "https://stream.zeno.fm/mixfm",
            logoText = "MIX",
        ...
        RadioStation(
            ...
            cityState = "São Paulo - SP",
            genre = RadioGenre.POP,
            streamUrl = "https://stream.zeno.fm/transamerica",
            backupStreamUrl = "https://ice.fabricahost.com.br/transamericasp",
            logoText = "TRANS",
            accentColorHex = 0xFFE65100,
            currentShow = "Conectados e Sucessos Pop Rock",
            bitrate = "128 kbps MP3"
        ),
        RadioStation(
            id = "bh_fm",
            ...
            genre = RadioGenre.POP,
            streamUrl = "https://stream.zeno.fm/bhfm",
            backupStreamUrl = "https://stream.zeno.fm/8k5rbbqmdg8uv",
            logoText = "BH FM",
